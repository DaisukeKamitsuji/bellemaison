...
var showvideo = function(pRefid, prep){
	...
	/**************************************************************
		...
		<object id="myExperience" class="BrightcoveExperience">
			...
			<param name="playerID" value="380292243002" />
			<param name="playerKey" value="AQ~~,AAAA3RWC_1k~,iXUOKogxQGxF5jyt5J7hSUKMOTzqV3yj" />
	...
	**************************************************************/
	var appendCode = $('<object id="myExperience" class="BrightcoveExperience"><param name="bgcolor" value="#FFFFFF" /><param name="width" value="576" /><param name="height" value="324" /><param name="playerID" value="380292243002" /><param name="playerKey" value="AQ~~,AAAA3RWC_1k~,iXUOKogxQGxF5jyt5J7hSUKMOTzqV3yj" /><param name="isVid" value="true" /><param name="isUI" value="true" /><param name="dynamicStreaming" value="true" /><param name="templateLoadHandler" value="showvideo.onTemplateLoaded" /><param name="@videoPlayer" value="12453" /><param name="includeAPI" value="true" /></object>');
